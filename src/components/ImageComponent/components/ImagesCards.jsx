...
const ImagesCards = ({ url }) => {
  ...
  return (
    <React.Fragment>
        <div className=" p-0 d-flex align-items-center justify-content-center position-relative" 
        css={css`
        width: fit-content;
        width: 220px;
        height: fit-content;
        ...
        border-image-source:linear-gradient(270deg, #f81ce5, #7928ca, #eb367f, #d4d4d4 93%);
        ...
        >
          ...
          transform:${translateFlag ? "translateY(0)" : "translateY(30px)"};
           `}
           >
              <p className='m-0 bg-transparent neon-grad fs-4 fw-semibold'>Rushal Creations</p>
           </div>
        </div>
    </React.Fragment>
  )
